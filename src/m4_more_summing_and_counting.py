...
import math
import builtins  # Never necessary, but here for pedagogical
...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 4
    answer = count_cosines_from(-2, 5, -0.4)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(2, 6, 0.4)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 4
    answer = count_cosines_from(1, 7, -0.1)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 1.5928  # This is APPROXIMATELY the correct answer.
